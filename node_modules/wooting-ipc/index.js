...
class wootingClient extends wootingConnection {
  ...
  hideOwnLayer(layer) {
    if (!this.connected) { return Promise.reject(dcError()); }
    return new Promise((resolve, reject) => this.send('layerVisible', { uid: `${this.id}-${layer.uid}`, v: false }, resolve));
  }
  showOwnLayer(layer) {
    if (!this.connected) { return Promise.reject(dcError()); }
    return new Promise((resolve, reject) => this.send('layerVisible', { uid: `${this.id}-${layer.uid}`, v: true }, resolve));
  }
  ...
  hideLayer(uid) {
    if (!this.connected) { return Promise.reject(dcError()); }
    return new Promise((resolve, reject) => this.send('layerVisible', { uid, v: false }, resolve));
  }
  showLayer(uid) {
    if (!this.connected) { return Promise.reject(dcError()); }
    return new Promise((resolve, reject) => this.send('layerVisible', { uid, v: true }, resolve));
  }
  moveLayer(uid, z) {
    if (!this.connected) { return Promise.reject(dcError()); }
